...
func (e *EvidenceEvaluator) GetRequiredEvidenceForPhase(phase types.OrchestrationPhase) []EvidenceRequirement {
	switch phase {
...
func (e *EvidenceEvaluator) EvaluateEvidence(workspace *WorkspaceInfo, phase types.OrchestrationPhase) (*EvidenceState, error) {
...
func (e *EvidenceEvaluator) GetMissingEvidence(workspace *WorkspaceInfo, phase types.OrchestrationPhase) []EvidenceRequirement {
...
func (e *EvidenceEvaluator) GetCriticalMissingEvidence(workspace *WorkspaceInfo, phase types.OrchestrationPhase) []EvidenceRequirement {
...
func (e *EvidenceEvaluator) CanProceedToPhase(workspace *WorkspaceInfo, targetPhase types.OrchestrationPhase) (bool, []string) {
...
func (e *EvidenceEvaluator) EvaluateAllPhases(workspace *WorkspaceInfo) map[types.OrchestrationPhase]*EvidenceState {
	phases := []types.OrchestrationPhase{
		types.PhaseProblem,
		types.PhaseKnowledge,
		types.PhaseFoundation,
		types.PhaseAudit,
		types.PhaseAssessment,
		types.PhaseArchitecture,
		types.PhaseImplementation,
		types.PhaseComplete,
	}

	results := make(map[types.OrchestrationPhase]*EvidenceState)
...
func (e *EvidenceEvaluator) GetEvidenceSummary(workspace *WorkspaceInfo) *EvidenceSummary {
	...
	summary := &EvidenceSummary{
		...
		CompletenessByPhase: map[types.OrchestrationPhase]float64{},
	}
...
type EvidenceSummary struct {
	PhaseStates          map[types.OrchestrationPhase]*EvidenceState `json:"phase_states"`
	TotalRequired        int                                   `json:"total_required"`
	TotalPresent         int                                   `json:"total_present"`
	OverallCompleteness  float64                               `json:"overall_completeness"`
	CriticalMissing      []string                              `json:"critical_missing"`
	CompletenessByPhase  map[types.OrchestrationPhase]float64 `json:"completeness_by_phase"`
}

// GenerateEvidenceCollectionPlan creates a plan for collecting missing evidence
func (e *EvidenceEvaluator) GenerateEvidenceCollectionPlan(workspace *WorkspaceInfo, targetPhase types.OrchestrationPhase) *EvidenceCollectionPlan {
...
type EvidenceCollectionPlan struct {
	TargetPhase types.OrchestrationPhase        `json:"target_phase"`
