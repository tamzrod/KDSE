...
| [005-engineering-artifacts.md](docs/foundation/005-engineering-artifacts.md) | Artifact definitions |
...
| [008-future-vision.md](docs/foundation/008-future-vision.md) | Long-term vision |
...
- **Structured Knowledge**: Validated understanding with explicit provenance, dependencies, and ownership
...
- **Authority Resolution**: How conflicts are resolved while maintaining hierarchy
